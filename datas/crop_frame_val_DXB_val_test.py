...
def crop_img(load_path=r'E:\Jiang\data\MOT\\',
    ...
    for dataset in datasets:
        ...
        elif dataset == 'DXB_train_val_test\\1460-1400\\':
            data = np.loadtxt(r'E:\Jiang\data\MOT\DXB_train_val_test\1460-1400\gt\gt.txt', delimiter=',', dtype=int).tolist()
        elif dataset == 'DXB_train_val_test\\1960-2690\\':
            data = np.loadtxt(r'E:\Jiang\data\MOT\DXB_train_val_test\1960-2690\gt\gt.txt', delimiter=',', dtype=int).tolist()
