...
def crop_img(load_path=r'E:\Jiang\data\MOT\\',
             save_path=r'E:\Jiang\data\MOT\SD',  # todo save_path
             # datasets=['1960-2690','250-2970'],
             # datasets=['1460-1400'],
             # datasets=['4570-3360', '8450-2180'],
             datasets=['SD\\9590-2960\\'],  # todo datasets
             cut_size=500,  # todo
             stride=500,
             ):
    save_id = 1
            ...
            for i in range(img_w // stride):  # 这里可能会有错
                for j in range(img_h // stride):
                    ...
                    np.save(os.path.join(save_path,
                                         'val\%03d_%s_%d_%d_%d.npy' % (save_id, dataset[3:-1], img_id, cut_x, cut_y)),  # todo dataset
