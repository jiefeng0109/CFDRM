...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='ctdet',
                                 help='ctdet')  # centernet
        self.parser.add_argument('--dataset', default='coco',
                                 help='coco')
        self.parser.add_argument('--exp_id', default='DXB_train_val_test')  # todo
        self.parser.add_argument('--test', action='store_true')
        self.parser.add_argument('--debug', type=int, default=0,  # 一开始是0
        ...
        self.parser.add_argument('--demo', default='',
                                 help='path to image/ image folders/ video. '
                                      'or "webcam"')
        self.parser.add_argument('--load_model', default='',  # exp/WeightPseudoDetection_ResNet18_SD/model_10.pth  # todo
                                 help='path to pretrained model')
        self.parser.add_argument('--resume', action='store_true',  # todo
        ...
        # system
        self.parser.add_argument('--gpus', default='0,1',  # 0,1 # todo
        ...
        # train
        self.parser.add_argument('--batch_size', type=int, default=4,  # todo
                                 help='batch size')
        self.parser.add_argument('--lr', type=float, default=0.32e-4,
                                 help='learning rate for batch size 32.')
        self.parser.add_argument('--lr_step', type=str, default='',
                                 help='drop learning rate by 10.')
        self.parser.add_argument('--num_epochs', type=int, default=30,  # 20,25
        ...
        self.parser.add_argument('--wh_weight', type=float, default=0.1,  # todo
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        print(opt.input_h, opt.input_w, opt.output_h, opt.output_w, opt.input_res, opt.output_res)
        if opt.task == 'ctdet':
