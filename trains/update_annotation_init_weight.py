...
if __name__ == '__main__':
    ...
    update_annotation(r'..\\exp\SkySat\results.json',
                      r'E:\Jiang\data\MOT\SkySat\pseudo_label\pseudo_0.json',
                      r'E:\Jiang\data\MOT\SkySat\pseudo_label\train',  # 这应该有两个文件
                      r'E:\Jiang\data\MOT\SkySat\pseudo_label',
                      100)
    # update_annotation(r'..\\exp\VISO\results.json',
    #                   r'E:\Jiang\data\RsCarData\\' + 'pseudo_0.json',  # 上一个保存的
